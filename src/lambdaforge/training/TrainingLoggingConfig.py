"""Training-level loss and metric logging policy."""
...
class TrainingLoggingConfig:
    """Control which training values reach Lightning and its progress bar.
    ...
    def from_value(
        cls,
        value: TrainingLoggingConfig | Mapping[str, Any] | None,
        ...
        raise TypeError("logging must be a TrainingLoggingConfig, mapping, or null.")
