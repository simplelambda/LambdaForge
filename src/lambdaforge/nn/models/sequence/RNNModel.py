"""Configurable recurrent neural-network sequence model."""
...
class RNNModel(Model):
    """Batch-first vanilla RNN with mask-aware output selection."""
    ...
    def forward(
        ...
        use_packing = padding_mask is not None or lengths is not None
        if use_packing:
