"""Mapping-based mean-absolute-error loss."""
...
class MeanAbsoluteErrorLoss(Loss):
    """Measure absolute regression error between configurable mapping keys."""
    ...
    def forward(
        ...
        return self.weight * F.l1_loss(prediction, target, reduction=self.reduction.value)
